...
namespace Applications.WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:WalletDev"]);
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, CoreEfCoreDbContext coreEfCoreDbContext)
        {
